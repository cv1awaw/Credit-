...
# Default handler (unknown messages)
...
def main():
    ...
    conv_handler = ConversationHandler(
        ...
        allow_reentry=False  # <--- Disable reentry to prevent repeated prompts
    )
